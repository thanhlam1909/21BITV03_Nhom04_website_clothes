...
namespace _21BITV03_Nhom04_website_clothes.Controllers
{
    public class MaterialsController : Controller
    {
        ...
        public MaterialsController(WebsiteClothesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MaterialId,MaterialName,Description")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaterialId,MaterialName,Description")] Material material)
        {
